...
public class CLUBParser extends Parser {
	...
	public final SetupContext setup() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 35725537968128L) != 0)) {
				{
				{
				setState(53);
				stmt();
	...
	@SuppressWarnings("CheckReturnValue")
	public static class PostF8Context extends PostfExprContext {
		public Token left;
		public TerminalNode SMETHODID() { return getToken(CLUBParser.SMETHODID, 0); }
		public PostF8Context(PostfExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CLUBListener ) ((CLUBListener)listener).enterPostF8(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CLUBListener ) ((CLUBListener)listener).exitPostF8(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CLUBVisitor ) return ((CLUBVisitor<? extends T>)visitor).visitPostF8(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final PostfExprContext postfExpr() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				{
				setState(222);
				((PostF5Context)_localctx).left = match(VMETHODID);
				}
				break;
			case 6:
				...
				{
				setState(223);
				((PostF6Context)_localctx).left = match(BMETHODID);
				}
				break;
			case 7:
				...
				{
				setState(224);
				((PostF7Context)_localctx).left = match(IMETHODID);
				}
				break;
			case 8:
				_localctx = new PostF8Context(_localctx);
				enterOuterAlt(_localctx, 8);
				{
				setState(225);
				((PostF8Context)_localctx).left = match(SMETHODID);
				}
				break;
			}
		}
