...
public class CLUBParser extends Parser {
	...
	public static final int
		AND=1, OR=2, EQ=3, SEQ=4, NOTEQ=5, SMALLER=6, LARGER=7, SMALLEREQ=8, BIGGEREQ=9, 
		INCREM=10, DECREM=11, PLUS=12, MINUS=13, MULT=14, DIVIDE=15, DOT=16, NOT=17, 
		ASSIGN=18, COMMA=19, SEMI=20, LPAREN=21, RPAREN=22, LCURLY=23, RCURLY=24, 
		LSQUARE=25, RSQUARE=26, WS=27, TURNCALL=28, SETUP=29, ROUND=30, TURN=31, 
		WHILE=32, FOR=33, IF=34, BOOL=35, INT=36, STRING=37, VMETHODID=38, BMETHODID=39, 
		IMETHODID=40, SMETHODID=41, PMETHODID=42, GETPLAYER=43, PLAYER=44, PLAYER2=45, 
		BOOLVAL=46, INTVAL=47, VARID=48, FUNCID=49, STRINGVAL=50, INTPARAM=51, 
		BOOLPARAM=52, STRINGPARAM=53;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "AND", "OR", "EQ", "SEQ", "NOTEQ", "SMALLER", "LARGER", "SMALLEREQ", 
	...
	public final SetupContext setup() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 846070171041792L) != 0)) {
				{
				{
				setState(53);
				stmt();
	...
	public static class Equal2Context extends EqualExprContext {
		...
		public TerminalNode SEQ() { return getToken(CLUBParser.SEQ, 0); }
