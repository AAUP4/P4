...
stmt : tParam op='=' logicOrExpr ';'   #Stmt1
        ...
        | left=FUNCID'('')' ';'        #Stmt6
        | left=TURNCALL'Player.getPlayer('param=(INTVAL|VARID)'))' ';'   #Stmt7
        | left=GETPLAYER param=(INTVAL|VARID)').score' ('++'|'--')  ';'         #Stmt8
        | left=PLAYER'.score' ('++'|'--')  ';'           #Stmt9
        ;
...
VMETHODID : 'Player.create('INTPARAM')'
        ...
        | 'player.discard(Player.getPlayer('INTPARAM').getCardIndex('INTPARAM'),Game.discardPile)'
        | 'Player.getPlayer('INTPARAM').discard('STRINGPARAM',player.getDiscardPile())'
        | 'Player.getPlayer('INTPARAM').discard(player.getCardIndex('INTPARAM'),Game.discardPile)'
        | 'player.discard('STRINGPARAM',player.getDiscardPile())'
        | 'player.discard(player.getCardIndex('INTPARAM'),Game.discardPile)'
        | 'player.discard(Player.getPlayer('INTPARAM').getCardIndex('INTPARAM'),Player.getPlayer('INTPARAM').getDiscardPile())'
        | 'player.discard(player.getCardIndex('INTPARAM'),Player.getPlayer('INTPARAM').getDiscardPile())'
        | 'player.discard(Player.getPlayer('INTPARAM').getCardIndex('INTPARAM'),player.getDiscardPile())'
        | 'player.discard(player.getCardIndex('INTPARAM'),player.getDiscardPile())'
        | 'Player.getPlayer('INTPARAM').discard(player.getCardIndex('INTPARAM'),Player.getPlayer('INTPARAM').getDiscardPile())'
        | 'Player.getPlayer('INTPARAM').discard(player.getCardIndex('INTPARAM'),player.getDiscardPile())'
        | 'Player.getPlayer('INTPARAM').discard(Player.getPlayer('INTPARAM').getCardIndex('INTPARAM'),player.getDiscardPile())'
