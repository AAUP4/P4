    ...
    public static boolean processInput(String input){
        ...
        if(input.contains(".")) {
            ...
            if (input.startsWith("deck.returnDiscardPile(Player.getPlayer(")) {
                Fparams.add("INT");
                method.concat("deck.returnDiscardPile(Player.getPlayer(INT");
                ...
                Fparams.add("INT");
                method.concat("table.discardAll(Player.getPlayer(INT");
                ...
                Fparams.add("INT");
                method.concat("table.discard(table.getCardIndex(INT");
                input = input.substring(33);
                Aparams.add(input.substring(0,input.indexOf(").")));
                input = input.substring(input.indexOf(")."));
                if (input.contains("(")){
                    Fparams.add("INT");
                    method.concat(input.substring(0,input.indexOf("(")+1));
                ...
                Fparams.add("INT");
                method.concat("Game.exit(Player.getPlayer(INT");
                ...
                Fparams.add("INT");
                method.concat("deck.getCard(INT");
                ...
                Fparams.add("INT");
                method.concat("Player.getPlayer(INT");
                input = input.substring(17);
                Aparams.add(input.substring(0, input.indexOf(").")));
                input = input.substring(input.indexOf(")."));
                if (input.startsWith(").getTable().getCardIndex(")) {
                    Fparams.add("INT");
                    method.concat(").getTable().getCardIndex(INT");
                    ...
                    Fparams.add("INT");
                    method.concat(").getDiscardPileIndex(INT");
                    ...
                    Fparams.add("INT");
                    method.concat(").getCardIndex(INT");
                    ...
                    Fparams.add("INT");
                    method.concat(").takeCard(Player.getPlayer(INT");
                    ...
                    if (input.startsWith(").getTable().getCardIndex(")) {
                        ...
                        if (input.startsWith(").id,Player.getPlayer(")) {
                            Fparams.add("INT");
                            method.concat(").id,Player.getPlayer(INT");
                            input = input.substring(22);
                            Aparams.add(input.substring(0, input.indexOf(").")));
                            input = input.substring(input.indexOf(")."));
                            method.concat(input);
                    ...
                    Fparams.add("INT");
                    method.concat(").takeCard(table.getCardIndex(INT");
                    ...
                    Fparams.add("INT");
                    method.concat(").takeCard(Game.getDiscardPileIndex(INT");
                ...
                Fparams.add("INT");
                method.concat("table.getCardIndex(INT");
                ...
                Fparams.add("INT");
                method.concat("Game.getDiscardPileIndex(INT");
                ...
                Fparams.add("INT");
                method.concat("deck.assignPoints(INT");
                input = input.substring(18);
                Aparams.add(input.substring(0, input.indexOf(",")));
                input = input.substring(input.indexOf(","));
                method.concat(",SLIST");
                ...
                Fparams.add("INT");
                method.concat("deck.addJokers(INT");
                input = input.substring(15);
                Aparams.add(input.substring(0, input.lastIndexOf(")")));
                input = input.substring(input.lastIndexOf(")"));
                method.concat(input);
                ...
                Fparams.add("INT");
                method.concat("Player.create(INT");
            ...
            //no methods start with BOOL param

            if (input.startsWith("Game.print(") || (input.startsWith("Game.input(") && !input.startsWith("Game.input()")) || (input.startsWith("table.discard(") && !input.startsWith("table.discard(table.getCardIndex("))) {
                
                if(input.startsWith("Game.print(")){
                    Fparams.add("STRING");
                    method.concat("Game.print(STRING");
                    input = input.substring(11);
                } else if(input.startsWith("Game.input(") && !input.startsWith("Game.input()")){
                    Fparams.add("STRING");
                    method.concat("Game.input(STRING");
                    input = input.substring(11);
                } else if((input.startsWith("table.discard(") && !input.startsWith("table.discard(table.getCardIndex("))){
                    Fparams.add("STRING");
                    method.concat("table.discard(STRING");
                    input = input.substring(14);
                }
                ...
                // Fparams.add("STRING");
                // method.concat(input.substring(0,input.indexOf('(')+1)+"STRING");
                // input = input.substring(input.indexOf('(')+1);
        ...
        if (Fparams.size()>0 && (VM.containsKey(method) || IM.containsKey(method) || SM.containsKey(method) || ATTI.containsKey(method) || ATTS.containsKey(method) || ATTB.containsKey(method)) && input == ""){
            result = true;
        }
        return result;
    }
